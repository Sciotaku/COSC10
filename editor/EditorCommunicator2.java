 ...
 */
public class EditorCommunicator2 extends Thread {
    private PrintWriter out;		// to server
    private BufferedReader in;		// from server
    protected Editor2 editor;		// handling communication for

    /**
     * Establishes connection and in/out pair
     */
    public EditorCommunicator2(String serverIP, Editor2 editor) {
        this.editor = editor;
